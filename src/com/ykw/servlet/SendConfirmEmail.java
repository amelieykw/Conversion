...
public class SendConfirmEmail {
	...
	private static final Logger log = Logger.getLogger(SendConfirmEmail.class.getName());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String message = "Your file " + videoName + " about " + description + " has been uploaded at " + creation_date
				+ "\n" + "The transcodage will be started immediately! Please wait for email!";
		...
		try {
			...
			msg.setSubject("Your video has been uploaded !");
			msg.setText(message);
			Transport.send(msg);
