...
public class SendProcessingEmail {
	...
	private static final Logger log = Logger.getLogger(SendProcessingEmail.class.getName());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String message = "Your file " + videoName + " about " + description + " has been uploaded at " + creation_date
				+ "\n" + "The transcodage is during the process! Please wait for final email!";
		...
		try {
			...
			msg.setSubject("The transcodage of your video is during the process !");
			msg.setText(message);
			Transport.send(msg);
