...
public class UploadGoldServlet extends HttpServlet {

	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		this.getServletContext().getRequestDispatcher("/WEB-INF/uploadGold.jsp").forward(request, response);
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		String[] gold_format = request.getParameterValues("gold_format");
		request.setAttribute("gold_format", gold_format);
	    ...
	    queue.add(TaskOptions.Builder
		 ...
		 this.getServletContext().getRequestDispatcher("/WEB-INF/confirmGold.jsp").forward(request, response);
	}
