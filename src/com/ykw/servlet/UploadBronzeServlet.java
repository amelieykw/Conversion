...
public class UploadBronzeServlet extends HttpServlet {

	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		this.getServletContext().getRequestDispatcher("/WEB-INF/uploadBronze.jsp").forward(request, response);
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		String bronze_format = request.getParameter("bronze_format");
		request.setAttribute("bronze_format", bronze_format);
	    ...
	    queue.add(TaskOptions.Builder
		 ...
		 this.getServletContext().getRequestDispatcher("/WEB-INF/confirmBronze.jsp").forward(request, response);
	}
