...
<html>
<head>
<title>Silver Format</title>
<meta charset="utf-8" />
</head>

<body>
	<h1>Envoyez un video dans le Cloud !</h1>
	<form action="<%=blobstoreService.createUploadUrl("/upload/silverFormat")%>"
		...
		<p>
		<fieldset>
			<legend>Silver (3 maximum):</legend>
			<input type="checkbox" name="silver_format" value="avi" />AVI <input
				type="checkbox" name="silver_format" value="wmv" />WMV <input
				type="radio" name="silver_format" value="mov" />MOV <input
